...
<div class="list__item">
    <article class="archive__item" itemscope="" itemtype="http://schema.org/CreativeWork">
      ...
      <a href="online link"><i class="fas fa-fw fa-link zoom" style="color:crimson" aria-hidden="true"></i></a> 
      <a href="pdf link 1"><i class="fas fa-fw fa-file-pdf-o zoom" style="color:crimson" aria-hidden="true"></i></a>
      <a href="pdf link 2"><i class="fas fa-fw fa-file-pdf-o zoom" style="color:crimson" aria-hidden="true"></i></a>
      <a target="_blank" rel="noopener noreferrer" href="slide link"><i class="fa fa-file-powerpoint-o zoom" style="color:crimson" aria-hidden="true"></i></a>
